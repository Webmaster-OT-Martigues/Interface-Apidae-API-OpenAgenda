...
/* https://extranet.martigues-tourisme.com/api-apidae-openagenda/apicmd.php?public=3cadd4ccb8484442a87432cf0f94c93a&secret=c071a53f48074d6c8c849fb1f0223f4e&apiKey=V0env9EH&projetId=6775
...
* Dossier apidae-openajenda
		API.php								-> Ce fichier ! 
		├── fonction 							-> Liste des fichiers .PHP 
		│   └── fonction_API.php 				-> Regroupe les fonctions d'appel à OpenAgenda et Apidae
		│    													
		├── config
		│	└──config.php					-> fichier de configuration des parametres.
		├── log/	 							-> Log et autres manip fait par l'API
		└── json								-> Exemple de fichier json de la ville de Martigues

		index.php								-> fichier AIDE et utilisation des fonctions
		├── fonction 							-> Liste des fichiers .PHP 
		│   └── fonction_API.php 				-> Regroupe les fonctions d'appel à OpenAgenda et Apidae
		│    													
		├── config
