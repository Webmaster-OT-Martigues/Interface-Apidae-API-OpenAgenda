	...
	<section class="p-relative" id="main" role="main">
		...
		<?php 
			echo'<ol class="breadcrumb hidden-xs" style="font-size: 11px;">
					...
					<li><a href="sig.php?test=oui">Mode Test</a></li>	
				</ol>';
		?>				
						...
						echo '</div>';
							...
							<?php
									...
									if ($dejafait==1) { 	
										...
										echo '<a href="pomapi.php?id_update='.$id_update.$valtest.'" target="_self" class="btn btn-sm btn-alt m-r-5">M.A.J</a>'; 
									}
									...
									if ($dejafait==0) {
										...
										if ($erreur_date>0) {
											echo '<a href="pomapi.php?id_create='.$retourfiche->id.''.$valtest.'" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Les dates/heures ont été corrigés" title="" data-original-title="Note de la publication" target="_self" class="btn btn-sm pover btn-alt m-r-5">AJOUTER</a>';
										}
										else {
											echo '<a href="pomapi.php?id_create='.$retourfiche->id.''.$valtest.'" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Aucune erreur détectée." title="" data-original-title="Note de la publication" target="_self" class="btn btn-sm pover btn-alt m-r-5">AJOUTER</a>';
										}
									}
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							<label for="inputName4" class="col-md-2 control-label">Paramètre URL</label>
							<div class="col-md-9">
								<br><br><br><br>
								index.php?public=<b>123456789123467891569<br><br>
								</b>&secret=<b>abcdefghijklmnopqrstuvwxyz123456</b><br><br>
								&apiKey=<b>ABCDEFGH</b><br><br>
								&projetId=<b>1234</b><br><br>
								&selectionIds1=<b>XXXXXX</b><br><br>
							</div>
						</div>
                    </form>
                </div>
